...
import { InstantAppProps, matchTriggerQueries } from "@felvin-search/core";
...
const Component = (props: InstantAppProps) => {
...
const queryToData = matchTriggerQueries(["latex"], { substringMatch: true });
