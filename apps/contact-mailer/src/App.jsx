...
function Component({ data: db }) {
 ...
 const findMatch=()=>{
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    window.open(`mailto:${data.mailto}?subject=${data.subject}&body=${data.body}`);
  }
  const handleSave = (e) => {
    e.preventDefault()
          ...
          <Form onSubmit={handleSubmit}>
            <Div>
              <div>
                ...
                <Input type="email" name="mailto" value={data.mailto} placeholder="Email address" onChange={handleOnChange} />
                <Input type="text" name="subject" placeholder="Subject" onChange={handleOnChange} />
              </div>
              <div>
                <TextArea name="body" type="text" placeholder="Message" onChange={handleOnChange}></TextArea>
              </div>
            </Div>
