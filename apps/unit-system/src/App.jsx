...
import unitstable from "./diffunits.json";
...
function Component({ data }) {
    ...
    const converter = () => {
        const metres = unitstable[inputlength]["metre"] * inputValue;
        setOutputValue(unitstable["metre"][outputlength] * metres);
    };
    useEffect(() => {
        converter();
    }, []);
...
const isValidLengthUnit = (str) => {
    ...
    if (lengthUnits.includes(str)) return true;
};
